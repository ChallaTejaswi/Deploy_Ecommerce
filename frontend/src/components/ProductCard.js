      ...
      <img 
        src={
          imageError 
            ...
            : (product.image || product.images?.[0] || 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=150&h=150&fit=crop&crop=center')
        } 
        alt={product.name} 
        ...
        onError={(e) => {
          if (!imageError) {
            setImageError(true);
            e.target.src = 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=150&h=150&fit=crop&crop=center';
          }
        }}
      />
